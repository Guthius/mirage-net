...
public sealed record EditSpell(SpellInfo SpellInfo) : IPacket<EditSpell>
{
    public static string PacketId => "editspell";

    public static EditSpell ReadFrom(PacketReader reader)
    {
        return new EditSpell(new SpellInfo
        {
            Id = reader.ReadInt32(),
